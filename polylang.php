...
define('POLYLANG_VERSION', '1.2.2.1');
...
class Polylang {
	...
	public function init() {
		...
		if (PLL_ADMIN) {
			...
			// delay to setup_theme as user roles must be defined before calling get_current_user_id()
			add_action('setup_theme', array($polylang, 'init'));
		}
